...
"""**0.1.10 Train Our Model Using SVM**"""
...
"""**0.1.11 Checking Accuracy of Testing data**"""

accuracy=(np.sum([prediction==Y_test])/Y_test.shape[0])*100
print("Testing Accuracy : ",accuracy)

"""**0.1.12 Checking Accuracy of data in K-Folds**"""

cvs=cross_val_score(svm_,X_train,Y_train,scoring='accuracy',cv=10)
print("After K-Folds Accuracy is %.3f"%(cvs.mean()*100))
for ind,val in enumerate(cvs):
  print("Accuracy of %d fold : %.3f"%(ind+1,val*100))

"""**0.1.13 Confusion-Matrix**"""
